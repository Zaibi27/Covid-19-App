...
import img1 from "./Asia.jpg"

export default  AsiaScreen = ({navigation}) => {
  ...
  return (
    <ImageBackground source={img1} style = {{ height: 900  , alignItems: "center" , paddingBottom: 78}}>
      <View style = {styles.title}> 
        <Ionicons name = "md-menu" size = {40} onPress = {() => navigation.openDrawer()} color = "lightgray" 
        style = {{paddingBottom: 12}} />
        <Text style= {{fontSize: 45 , color: "khaki" , paddingBottom: 10 , paddingLeft : 60 ,
             paddingRight: 100, fontWeight: "bold"    }}> Asia Stats</Text>
        </View>
        ...
        renderItem = {({item , index }) => (
          <View style = {styles.area} >
            <View style={{ padding: 15, backgroundColor: 'black' , opacity: 0.7  , marginBottom: 5
