...
import NAmerica from "./NAmerica.jpg"

export default NAmericaScreen = ({navigation}) => {
    const [getData , setData] = useState() ;
    const  [getLoading , setLoading] = useState(true) ;
  
    const fetchCountries = () => {
  
    fetch("https://covid19-update-api.herokuapp.com/api/v1/world/continent/north")
  ...
  return (
    <ImageBackground source={NAmerica} style = {{ height: 900  , alignItems: "center" , paddingBottom: 78}}>
      <View style = {styles.title}> 
        ...
        <Text style= {{fontSize: 42 , color: "khaki" , paddingBottom: 10   ,
              fontWeight: "bold" , textAlign: "center"    }}> North America Stats</Text>
        </View>
        ...
        renderItem = {({item , index }) => (
          <View style = {styles.area} >
            <View style={{ padding: 15, backgroundColor: 'gray' , opacity: 0.7 , marginBottom: 5
